...
> 配套这个产品，开发了一个非常强大的赶超八爪鱼的爬虫产品 iCrawler，后来由于数据安全监管法律等原因，于2019年连同查呗一起下线，现存于归档代码库。
...
2. 马敏，iJEP 平台首席架构师，核心代码贡献者，没有他就没有 iJEP 的今天。从2004年开始，我和他就在联合金投公司共事，一个技术狂人，大年初一都要写代码的人，对代码有洁癖的人；
...
智能表单，是 iJEP 7 平台的主要组件，分为设计时和运行时两个组件。

目标是提供在线设计工具，让后端程序员在前后端分离的时代能够管控前端做一个全栈工程师，知道自己做的软件是啥样的，让项目经理回归垂直分配工作：功能A给程序员张三，功能B给程序员李四。

减少前后端沟通，消除前后端**阻抗失配**，提高交付效率，降低交付成本。

> 我们的口号是：让程序员早点儿下班。

业界智能表单大部分是参照早期 VB、Delphi 的窗口设计器模式，以画布的形式提供界面设计功能。
...
本章对 iJEP 7 的发展历史做了回顾，作为一个全程参与者，感慨万千，算是对得上**“十年磨一剑”**的工匠精神。
